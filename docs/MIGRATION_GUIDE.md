...
3. **バージョンヘッダーの更新**: `<!-- Template Version: 3 (2025-10-15) -->` を `<!-- Template Version: 4 (2025-10-15) -->` に変更
...
**注意事項:**
- マーカーはHTMLコメントなので、GitHub UIでは表示されません
- マーカーはissyncがコメントを識別するために使用されます
- 既存のplan.mdにマーカーがない場合でも、issyncは正常に動作しますが、マーカーを追加することで将来的な互換性が向上します

---

## Version 4 以降のマイグレーション例
